...
cnn = torch.load('../Some_Pickled_Models/cnn_good.pt')
cnn.eval()
...
test_scores = eval_model(cnn, testingQuestionIds, testing_data, word2vec, id2Data, truncation_val_title, truncation_val_body)
