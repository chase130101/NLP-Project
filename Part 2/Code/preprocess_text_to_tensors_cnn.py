...
def construct_qs_matrix_training(q_ids_sequential, cnn, word2vec, id2Data, dict_sequence_lengths,
    ...
    for q in q_ids_complete:
        q_matrix_3d_title, q_num_words_title = get_question_matrix_title(q, id2Data, word_to_id_vocab, word2vec, truncation_val_title)
        qs_matrix_list_title.append(q_matrix_3d_title)
        qs_seq_length_title.append(q_num_words_title)
        q_matrix_3d_body, q_num_words_body = get_question_matrix_body(q, id2Data, word_to_id_vocab, word2vec, truncation_val_body)
...
def construct_qs_matrix_testing(q_ids, cnn, word2vec, id2Data, word_to_id_vocab, truncation_val_title, truncation_val_body, main = False):
    qs_matrix_list_title = []
    qs_seq_length_title = []
    qs_matrix_list_body = []
    qs_seq_length_body = []
...
def construct_qs_matrix_domain_classification(domain_ids, cnn, word2vec, domain_specific_id_to_data, word_to_id_vocab, truncation_val_title, truncation_val_body):
    qs_matrix_list_title = []
    qs_seq_length_title = []
    qs_matrix_list_body = []
    qs_seq_length_body = []
    ...
    for q in domain_ids:
        q_matrix_3d_title, q_num_words_title = get_question_matrix_title(q, domain_specific_id_to_data, word_to_id_vocab, word2vec, truncation_val_title)
        qs_matrix_list_title.append(q_matrix_3d_title)
        qs_seq_length_title.append(q_num_words_title)
        q_matrix_3d_body, q_num_words_body = get_question_matrix_body(q, domain_specific_id_to_data, word_to_id_vocab, word2vec, truncation_val_body)
        qs_matrix_list_body.append(q_matrix_3d_body)
        qs_seq_length_body.append(q_num_words_body)
